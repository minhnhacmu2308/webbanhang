                ...
                <nav aria-label="Page navigation example" class="d-flex justify-content-center">
                  <ul class="pagination">
                    ...
                    <%  for(int i = 1 ;i <= numberPage ; i++){ %>
                     <% if(tagPage==i){ %>
                    <li class="page-item active"><a href="<%= request.getContextPath()%>/categoryfull?page=<%=i %>" class="page-link"><%= i %></a></li>
                    <%}else{ %>
                     <li class="page-item "><a href="<%= request.getContextPath()%>/categoryfull?page=<%=i %>" class="page-link"><%= i %></a></li>
                    <%} %>
                    <%} %>
