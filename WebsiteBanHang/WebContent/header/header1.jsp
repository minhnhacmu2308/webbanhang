...
<body>
   <div id="top">
            ...
            <div class="col-lg-6 text-center text-lg-right">
              <ul class="menu list-inline mb-0">
                <%
			      ...
			      %>
			      <% if(fullName != ""){ %>
			       <li class="list-inline-item"><a href="detailuser?username=<%= user.getUserName()%>">Xin chào, <%= fullName%></a></li>
      ...
      <nav class="navbar navbar-expand-lg">
        <div class="container"><a href="<%=request.getContextPath()%>/home" class="navbar-brand home"><img src="img/logo.png" alt="Obaju logo" class="d-none d-md-inline-block"><img src="img/logo-small.png" alt="Obaju logo" class="d-inline-block d-md-none"><span class="sr-only">Obaju - go to homepage</span></a>
          ...
          <%}} %>
            ...
            <div class="navbar-buttons d-flex justify-content-end">
              ...
              <div id="basket-overview" class="navbar-collapse collapse d-none d-lg-block"><a href="<%=request.getContextPath()%>/order" class="btn btn-primary navbar-btn"><i class="fa fa-shopping-cart"></i><span> <%= numberOrder %> items in cart</span></a></div>
            </div>
          </div>
        </div>
      </nav>
