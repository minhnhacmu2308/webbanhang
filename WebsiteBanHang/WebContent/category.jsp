            ...
            <div class="col-lg-9">
              ...
              <div class="pages">
                ...
                <nav aria-label="Page navigation example" class="d-flex justify-content-center">
                  <ul class="pagination">
                  <% int size = 0 ;
                  size= newsListProduct.size()/9;
                     if(size<1){
                    	 size=1;
                     }else if(newsListProduct.size()%9!=0){
                    	 size++;
                     }
                  %>
                    <li class="page-item"><a href="#" aria-label="Previous" class="page-link"><span aria-hidden="true">«</span><span class="sr-only">Previous</span></a></li>
                    <% for(int i=1;i<=size;i++){ %>
                    <li class="page-item active"><a href="<%=request.getContextPath()%>/category?caId=<%=catId %>&page=<%=i %>" class="page-link"><%=i%></a></li>
                    <%} %>
