            ...
            <div class="col-lg-3">
              ...
              *** CUSTOMER MENU ***
              ...
              <div class="card sidebar-menu">
                ...
                %>
                <div class="card-body">
                  <ul class="nav nav-pills flex-column"><a href="customer-orders.jsp" class="nav-link "><i class="fa fa-list"></i> My orders</a>
                  <a href="customer-wishlist.jsp" class="nav-link"><i class="fa fa-heart"></i> My wishlist</a>
                  ...
                  <div class="row">
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <input id="firstname" value="<%= user.getFullName() %>" type="text" class="form-control">
                      </div>
                    </div>
                   <div class="col-md-6">
                      <div class="form-group">
                        <label for="firstname">Number Phone</label>
                        <input id="firstname" value="<%= user.getPhoneNumber() %>" type="text" class="form-control">
                      </div>
                    </div>
                  </div>
                  <!-- /.row-->
                  <div class="row">
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <input id="company" value="<%= user.getAddress() %>" type="text" class="form-control">
                      </div>
                    </div>
                    <div class="col-md-6">
                      <div class="form-group">
