      ...
      <div id="content">
        <div class="container">
          <div class="row">
            ...
            <div class="item"><img  src="https://www.thuengay.vn/uploads/770x433/db8e335e4f8e122d3247542967482f123f88882c2.jpg" alt="" class="img-fluid"></div>
                <div class="item"><img  src="https://www.thuengay.vn/uploads/770x433/c84351d7e2be3b302a37aad5addf3ad727eba0732.jpg" alt="" class="img-fluid"></div>
             <div class="item"><img src="img/banner10.jpg" alt="Get inspired" class="img-fluid"></a></div>
              </div>
              <!-- /#main-slider-->
            </div>
          </div>
            ...
            <div class="product-slider owl-carousel owl-theme">
              		    ...
              		    <%          
                             List<ProductModel> newsListProduct = null;
                             	...
                             	if(request.getAttribute("listH")!=null){
                             		newsListProduct = (List<ProductModel>) request.getAttribute("listH");
                ...
                <div class="product">
                  ...
                  </div><a href="detail.jsp" class="invisible"><img src="img/<%=newsListProduct.get(j).getProductPicture() %>" alt="" class="img-fluid"></a>
                  <div class="text">
          ...
          <div class="col-md-12">
            <div class="box slideshow">
              ...
              <div id="get-inspired" class="owl-carousel owl-theme">
                 <div class="item"><img  src="https://www.thuengay.vn/uploads/770x433/4294054797127e00ce6166eb936008201dc18e902.jpg" alt="" class="img-fluid"></div>
                <div class="item"><img  src="https://www.thuengay.vn/uploads/770x433/c84351d7e2be3b302a37aad5addf3ad727eba0732.jpg" alt="" class="img-fluid"></div>
             <div class="item"><img src="img/banner10.jpg" alt="Get inspired" class="img-fluid"></a></div>
              </div>
            </div>
